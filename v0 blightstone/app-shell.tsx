          ...
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            <div className="flex flex-col items-start min-w-0 flex-1">
              <div className="flex items-center gap-2 w-full">
                <span className="font-medium text-foreground truncate">{currentProject.name}</span>
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground w-full">
                ...
                <span>•</span>
                <span>
                  {currentProject.completedTasks}/{currentProject.tasksCount} tasks
                </span>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {project.id === currentProjectId && <Check className="h-4 w-4 text-black" />}
                </div>
        ...
        {collapsed ? (
          <div className="w-full flex justify-center">
            <Button variant="ghost" size="icon" className="rounded-full hover:bg-accent">
              <span className="text-sm font-semibold text-black">GC</span>
            </Button>
          </div>
        ) : (
          <ProjectSelector />
        ...
        {sidebarItems.map((item) => {
          ...
          return (
            <div key={item.name}>
              ...
              >
                <Icon className={cn(isActive(item.href) ? "text-black" : "", collapsed ? "h-5 w-5" : "h-4 w-4 mr-3")} />
...
function Topbar() {
  ...
  const getPageTitle = () => {
    ...
    if (pathname === "/dashboard/creative-tracker") return "Creative Tracker"
    if (pathname === "/dashboard/personas") return "Personas"
    if (pathname === "/dashboard/competitors") return "Competitor Analysis"
    // Removed "Awareness Stages" from title logic
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="icon" className="rounded-full hover:bg-accent">
              <Avatar className="h-8 w-8">
                ...
                <AvatarFallback className="bg-black text-white">{user.initials}</AvatarFallback>
              </Avatar>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-64 bg-popover border-border p-0">
            ...
            <div className="p-2 border-t border-border">
              <Button className="w-full bg-black hover:bg-black/90 text-white border-0" size="sm">
                Upgrade Plan
              </Button>
            </div>
          </DropdownMenuContent>
