-- Fix get_tickets_with_metadata function to remove priority column references
-- The priority column was removed from support_tickets table but function still references it

-- Drop and recreate the function without priority
