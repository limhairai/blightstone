        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[100, 500, 1000, account.balance].map((quickAmount, index) => (
                <Button
                  key={index}
                  variant="outline"
                  size="sm"
                  ...
                  disabled={quickAmount > account.balance || quickAmount <= 0}
                >
          ...
          {withdrawAmount > account.balance * 0.8 && withdrawAmount <= account.balance && (
            <div className="flex items-center gap-2 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <AlertTriangle className="h-4 w-4 text-yellow-500" />
              <span className="text-sm text-yellow-700 dark:text-yellow-400">
                This will leave a low balance in your account
              </span>
            </div>
          )}
