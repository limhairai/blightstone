...
class DolphinCloudAPI:
    ...
    # Note: Facebook Pages data is extracted from Business Manager and Ad Account responses
    # rather than a dedicated endpoint, similar to how pixel data is handled
