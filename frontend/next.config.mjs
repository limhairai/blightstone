      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: http://127.0.0.1:*; media-src 'self' data: https: http://127.0.0.1:*; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://api.stripe.com https://*.supabase.co wss://*.supabase.co http://127.0.0.1:54333 ws://127.0.0.1:54333 https://vitals.vercel-analytics.com https://vitals.vercel-insights.com; frame-src https://js.stripe.com https://vercel.live;",
          },
        ],
      },
    ];
