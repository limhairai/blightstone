...
export function BusinessesMetrics() {
  ...
  const totalAccounts = MOCK_BUSINESSES.reduce((total, business) => total + business.accountsCount, 0)
  const totalSpend = MOCK_BUSINESSES.reduce((total, business) => total + business.totalSpend, 0)
