...
import { Loader2, ArrowDownLeft, Wallet, Target, AlertCircle, CheckCircle, Check } from "lucide-react"
...
export function BalanceResetDialog({ trigger, account, accounts, onSuccess, open: controlledOpen, onOpenChange }: BalanceResetDialogProps) {
        ...
        <DialogContent className="sm:max-w-md">
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">
              Your balance reset request has been submitted for review. You'll be notified once it's processed.
            </p>
          </div>
        </DialogContent>
      </Dialog>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-md">
            ...
            <div className="text-sm text-muted-foreground">
              <strong>Important:</strong> This request will be reviewed and processed. 
              The balance will be transferred to your chosen destination once approved.
            </div>
          </div>
