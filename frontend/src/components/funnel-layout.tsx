    ...
    <div className="min-h-screen bg-black flex flex-col">
      <header className="border-b border-[#222222] py-4">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <Link href="/dashboard" className="text-2xl font-bold">
            <span className={`bg-gradient-to-r from-[#b19cd9] to-[#f8c4b4] text-transparent bg-clip-text`}>AdHub</span>
          </Link>
      ...
      <main className="flex-1">
        <div className="text-center pt-12 pb-10">
          <h1 className={`text-4xl font-bold mb-4 ${gradients.headingText}`}>{title}</h1>
      ...
      <footer className="py-8 border-t border-[#222222] mt-16">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-sm text-[#666666]">© 2025 AdHub. All rights reserved.</p>
          </div>
