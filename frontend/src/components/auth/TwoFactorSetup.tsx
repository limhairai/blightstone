  ...
  async function fetchStatus() {
    ...
    try {
      ...
      if (e instanceof Error) {
        ...
        setError("An unknown error occurred while loading 2FA status.");
      }
    } finally {
      setLoading(false);
    }
  ...
  async function startSetup() {
    ...
    try {
      ...
      if (e instanceof Error) {
        ...
        setError("An unknown error occurred while generating 2FA secret.");
      }
    } finally {
      setLoading(false);
    }
  ...
  async function enable2fa(e: React.FormEvent) {
    ...
    try {
      ...
      if (e instanceof Error) {
        ...
        setError("An unknown error occurred while enabling 2FA.");
      }
    } finally {
      setLoading(false);
    }
  ...
  async function disable2fa() {
    ...
    try {
      ...
      if (e instanceof Error) {
        ...
        setError("An unknown error occurred while disabling 2FA.");
      }
    } finally {
      setLoading(false);
    }
