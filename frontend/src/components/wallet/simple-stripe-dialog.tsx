...
interface SimpleStripeDialogProps {
  open: boolean
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-blue-900">Wallet Credit</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xl font-bold text-blue-900">${totalCharge.toFixed(2)}</span>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="p-4 bg-white border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
...
export function SimpleStripeDialog({ 
  open, 
  onOpenChange, 
  amount,
  onSuccess
}: SimpleStripeDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] bg-white border border-gray-200 shadow-xl p-0">
