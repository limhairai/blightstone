    ...
    return (
      <div className="p-4">
        <Alert variant="destructive">
          ...
          <AlertDescription>{error || "Could not load projects."}</AlertDescription>
          ...
          <DialogContent className="bg-[#0f0a14] border-[#2C2C2E] sm:max-w-[600px]">
            ...
            <form className="flex flex-col gap-4" onSubmit={e => { e.preventDefault(); handleAddProject(); }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="addProjectName" className="block text-sm font-medium mb-1 text-gray-400">Project Name</label>
                  <Input
                    id="addProjectName"
                ...
                <div>
                  <label htmlFor="addProjectDomains" className="block text-sm font-medium mb-1 text-gray-400">Domains (comma separated)</label>
                  <Input
                    id="addProjectDomains"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="addProjectFacebookUrl" className="block text-sm font-medium mb-1 text-gray-400">Facebook Page URL (optional)</label>
                  <Input
                    id="addProjectFacebookUrl"
                ...
                <div>
                  <label htmlFor="addProjectTimezone" className="block text-sm font-medium mb-1 text-gray-400">Timezone (e.g. UTC, PST)</label>
                  <Input
                    id="addProjectTimezone"
        ...
        <Dialog open={assignOpen} onOpenChange={setAssignOpen}>
          <DialogContent className="max-w-lg">
            ...
            <div className="max-h-64 overflow-y-auto border rounded p-2 bg-[#18181b]">
              {adAccounts
                .filter((a: any) => assignSearch ? a.name?.toLowerCase().includes(assignSearch.toLowerCase()) : true)
                .map((a: any) => (
