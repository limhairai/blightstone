...
export function ProfessionalFeaturesSection() {
  ...
  return (
    <section
      ref={ref}
      className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-all duration-1000 ease-out transform ${
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-[#1a1a1a]/80 to-[#2a2a2a]/60 backdrop-blur-sm rounded-3xl border border-white/10 p-8 shadow-2xl flex flex-col group hover:shadow-[0_0_50px_rgba(180,160,255,0.1)] hover:border-white/20 transition-all duration-500">
            <div className="bg-[#0a0a0a]/50 rounded-2xl p-6 border border-white/5 relative h-80 flex flex-col group-hover:border-white/10 transition-all duration-300 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-white/60 text-sm">Real-time Dashboard</span>
                  <div className="flex items-center gap-2 bg-blue-500/20 px-3 py-1 rounded-full border border-blue-500/30 backdrop-blur-sm">
                ...
                <div className="flex-1 flex flex-col gap-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gradient-to-r from-[#2a2a2a] to-[#3a3a3a] rounded-lg p-2 border border-white/5 hover:border-white/10 transition-colors"><div className="text-white/60 text-xs mb-1">Total Spend</div><div className="text-white font-semibold">$24,750</div></div>
                    <div className="bg-gradient-to-r from-[#2a2a2a] to-[#3a3a3a] rounded-lg p-2 border border-white/5 hover:border-white/10 transition-colors"><div className="text-white/60 text-xs mb-1">Active Accounts</div><div className="text-white font-semibold">12</div></div>
                  </div>
