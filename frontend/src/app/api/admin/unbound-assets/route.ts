...
// GET /api/admin/unbound-assets?type=<asset_type>
export async function GET(request: NextRequest) {
  ...
  try {
    // This query performs a LEFT JOIN from dolphin_assets to client_asset_bindings
    // and returns only the rows from dolphin_assets where there is no corresponding
    ...
    // The query returns the nested binding as `client_asset_bindings: null`, 
