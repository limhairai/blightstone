...
import { type AppBusiness, type AppAccount, type AppTransaction, type AppOrganization, type TeamMember } from '../contexts/AppDataContext'
...
export const APP_ORGANIZATIONS: AppOrganization[] = [
  {
    ...
    webhooks: [
      {
        id: "wh_001",
        url: "https://api.demo.com/webhooks/adhub",
...
export const accounts: Account[] = [
  ...
  },
  {
    ...
    spendToday: 0,
    spendLimit: "$0.00",
    dateAdded: "Apr 27, 2024",
    dateCreated: "Apr 27, 2024",
    lastActive: undefined,
    hasIssues: true,
  },
]
...
export const APP_BUSINESSES: AppBusiness[] = [
  // Businesses for Demo Company (org1)
  {
    id: "1",
...
export const APP_BUSINESSES_BY_ORG: Record<string, AppBusiness[]> = {
  "org1": APP_BUSINESSES, // Demo Company
  "org2": [
    {
      id: "p1",
...
export const APP_ACCOUNTS_BY_ORG: Record<string, AppAccount[]> = {
  "org1": APP_ACCOUNTS, // Demo Company (existing accounts)
  "org2": [ // Personal Account
    {
      id: "101",
...
export const APP_TRANSACTIONS_BY_ORG: Record<string, AppTransaction[]> = {
  "org1": APP_TRANSACTIONS, // Demo Company (existing transactions)
  "org2": [ // Personal Account
    {
      id: "101",
      description: "Ad Spend",
...
export const MOCK_TEAM_MEMBERS_BY_ORG: Record<string, TeamMember[]> = {
  "org1": [ // Demo Company
    {
      id: "user_001",
      name: "John Smith",
