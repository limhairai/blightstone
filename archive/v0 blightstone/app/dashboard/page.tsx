        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">New personas added this month</p>
            </CardContent>
          </Card>
        </div>
        <div className="min-h-[300px] rounded-lg border border-dashed p-6 text-center text-muted-foreground flex items-center justify-center">
