...
import { CreditCard, Calendar, Copy, Zap, Edit, AlertTriangle, Trash2, Plus } from "lucide-react"
...
export function OrganizationSettings() {
  ...
  const availablePlans = [
    { id: "starter", name: "Starter", price: 29, adAccountsLimit: 20 },
    { id: "business", name: "Business", price: 49, adAccountsLimit: 50, current: true },
    { id: "enterprise", name: "Enterprise", price: 99, adAccountsLimit: 200 },
  ]
      ...
      <div className="lg:col-span-2 space-y-6">
          ...
          <CardHeader className="pb-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button
                ...
                onClick={() => {
                  setFormData({ ...formData, name: orgData.name })
                  setEditOrgOpen(true)
                }}
              >
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-1 text-foreground font-medium">{orgData.name}</div>
              </div>
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => copyToClipboard(orgData.id)} className="h-6 w-6 p-0">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-1 text-foreground">{orgData.memberSince}</div>
              </div>
              <div>
                <label className="text-sm font-medium text-muted-foreground">Active Businesses</label>
                <div className="mt-1 text-foreground">{orgData.businessCount || 3}</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border border-red-800/30">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg font-semibold text-red-400">Danger Zone</CardTitle>
        ...
        <Card className="bg-card border border-border">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Badge className="bg-gradient-to-r from-[#c4b5fd] to-[#ffc4b5] text-white border-0">{orgData.plan}</Badge>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {plan.current && (
                        <Badge className="bg-gradient-to-r from-[#c4b5fd] to-[#ffc4b5] text-white border-0">
                          Current
                        </Badge>
                      )}
                    </div>
                    <p className="text-sm text-muted-foreground">Up to {plan.adAccountsLimit} ad accounts</p>
                  </div>
