...
export function CryptoPaymentForm({ amount }: CryptoPaymentFormProps) {
  ...
  const cryptoOptions = [
    {
      ...
      rate: 0.000016, // USD to BTC conversion rate (example)
    },
    {
      id: "eth",
      name: "Ethereum (ETH)",
      address: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e",
      rate: 0.00025, // USD to ETH conversion rate (example)
    },
    {
      id: "usdt",
      name: "Tether (USDT)",
      address: "TKTcfBEKpp5ZRPwXxeJkRdJpUWSHG1xXNB",
      rate: 1, // USD to USDT conversion rate (example)
    },
  ]
