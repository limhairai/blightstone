...
export default function ActiveClientsPage() {
  return (
    <AdminLayout title="Active Clients">
      <div className="flex flex-col space-y-8">
        {/* Header with stats */}
        <div className="flex flex-col space-y-2">
          <h1 className="text-2xl font-bold flex items-center">
            <Users className="mr-2 h-6 w-6 text-[#b4a0ff]" /> Active Clients
          </h1>
          <p className={`${colors.textMuted}`}>View and manage clients with active ad accounts</p>
        </div>
        ...
        <Card className={`${colors.cardGradient} ${colors.cardBorder} border`}>
          <CardHeader>
            ...
            <CardDescription>Clients with at least one active ad account</CardDescription>
          </CardHeader>
          <CardContent>
            <AdminClientsList />
          </CardContent>
